...
export const messages: Record<string, string> = {
  ...
  'cmd.login.lark_note': 'This authorizes lark-cli\'s general-purpose app and does not depend on this bot app\'s availability scope — anyone in the group can self-authorize. Afterwards, lark-cli actions you trigger (docs / drive / wiki / sheets) run with your own permissions. Long-lived, auto-refreshing.',
