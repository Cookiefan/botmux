...
export const messages: Record<string, string> = {
  ...
  'card.traex_init.owner_only': 'Only the session creator or a bot admin can operate this initialization card',
  ...
  'cmd.reply_mode.status': 'Current group reply mode: {mode}\nCommands: /reply-mode chat | chat-topic | topic | shared | new-topic (shared remains a compatibility alias for topic)',
  ...
  'help.reply_mode': '/reply-mode [status|chat|chat-topic|topic|shared|new-topic] - Show/change regular-group or DM reply/session mode',
