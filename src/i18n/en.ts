...
export const messages: Record<string, string> = {
  ...
  'trigger_user_auth.denied_auto_login': 'botmux: ByteCloud login has started automatically. Open this link to authorize:',
  'trigger_user_auth.denied_auto_retry': 'botmux: retry the original action after authorizing; Botmux completes the login automatically, so you do not need to send /login bytedcli or done.',
