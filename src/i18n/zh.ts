...
export const messages: Record<string, string> = {
  ...
  'card.traex_init.owner_only': '仅本次会话的发起人或 Bot 管理员可操作初始化卡',
  ...
  'cmd.reply_mode.status': '当前群回复模式：{mode}\n可用命令：/reply-mode chat｜chat-topic｜topic｜shared｜new-topic（shared 仍作为 topic 的兼容别名）',
  ...
  'help.reply_mode': '/reply-mode [status|chat|chat-topic|topic|shared|new-topic] - 查看/切换普通群或私聊的回复/会话模式',
