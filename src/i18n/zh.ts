...
export const messages: Record<string, string> = {
  ...
  'cmd.close.worktree_thread_only': '⚠️ `/close wt` 只用于 `/tw` 创建的子话题。普通群顶层会话请使用 `/close`。',
  'cmd.close.worktree_not_linked': '⚠️ 当前会话目录不是 linked worktree；已拒绝删除。普通会话请直接用 /close。',
  'cmd.close.worktree_removed': '🧹 已关闭当前会话、额外关闭 {count} 个同 worktree 会话，并移除 worktree：`{path}`',
  'cmd.close.worktree_confirm_title': '确认关闭话题并删除 worktree',
  'cmd.close.worktree_confirm_sessions': '将关闭会话 {count} 个（含当前）',
  'cmd.close.worktree_confirm_effect': '删除后：未提交改动会丢失；未 push 的提交仍留在本地分支，但 worktree 目录被移除。',
  'cmd.close.worktree_confirm_button': '确认关闭并删除',
  'cmd.close.worktree_confirm_no_perm': '只有机器人操作员才能关闭会话并删除 worktree。',
  'cmd.close.worktree_confirm_not_invoker': '只有发起本次确认的用户可以执行。',
  'cmd.close.worktree_confirm_received': '请求已处理，请查看话题中的结果。',
  'cmd.close.worktree_state_changed': '⚠️ worktree 状态在确认卡生成后发生变化；本次未关闭会话、未删除目录。请检查下方最新确认卡后重试。',
  'cmd.close.worktree_confirm_path_label': '将删除 worktree',
  'cmd.close.worktree_col_bot': '机器人',
  'cmd.close.worktree_col_task': '当前任务',
  'cmd.close.worktree_current_tag': '·当前',
  'cmd.close.worktree_bot_unknown': '未知机器人',
  'cmd.close.worktree_checks_label': '安全检查',
  'cmd.close.worktree_check_dirty_ok': '✅ 未提交改动：无',
  'cmd.close.worktree_check_dirty_warn': '⚠️ 未提交改动：{n} 个文件',
  'cmd.close.worktree_check_ahead_ok': '✅ 未 push 提交：无',
  'cmd.close.worktree_check_ahead_warn': '⚠️ 未 push 提交：{n} 个',
  'cmd.close.worktree_effect_safe': '此 worktree 干净，删除不会丢失代码。',
  'cmd.close.worktree_confirm_risky': '⚠️ 准备关闭并删除这个 worktree：\n- 其它同 worktree 活跃会话：{count} 个\n- 未提交改动：{dirty}\n- 未 push 提交：{ahead} 个\n确认要继续，请发送 `/close wt --yes`。',
  'cmd.close.worktree_confirm_shared': '⚠️ 还有 {count} 个活跃会话也在这个 worktree 下。确认要一起关闭并删除 worktree，请发送 `/close wt --yes`。',
  'cmd.close.worktree_sibling_close_failed': '⚠️ 当前会话已关闭，但使用 `{path}` 的其他 {count} 个会话未能关闭。worktree 未删除；请等所属 daemon 恢复后，从剩余会话重试。',
  'cmd.close.worktree_remove_failed': '⚠️ 会话已关闭，但移除 worktree `{path}` 失败：{error}',
  ...
  'cmd.repo.here_missing': '⚠️ 当前群聊还没有可复用的工作目录。请先在普通群启动一个会话或使用 /oncall bind 绑定目录。',
  ...
  'cmd.project.no_bot': '⚠️ 无法识别当前响应的机器人，/project 无法执行。',
  'cmd.project.no_chat': '⚠️ 无法识别当前群聊，/project 无法执行。',
  'cmd.project.no_owner': '⚠️ 本机器人未配置 allowedUsers（无 owner），不能通过群聊修改项目群配置。请先在 Dashboard 或部署机器上配置管理员。',
  'cmd.project.not_admin': '⛔ 仅 owner / allowedUsers 可修改项目群配置。',
  'cmd.project.help': '📌 /project —— 管理当前普通群的项目协作模式（仅 owner/allowedUsers）\n\n@机器人 /project enable   — 当前机器人作为主控，群内其余本机 Bot 作为 Worker；后续新 Bot 自动纳入\n@机器人 /project status   — 查看配置与项目状态\n@机器人 /project roles    — 配置主控与 Worker 在本群的角色\n@机器人 /project disable  — 退出项目群模式\n\n启用时不要求目标已经明确；可以先在群顶层 @主控讨论，目标成熟后再让主控正式立项。Worker 名单与自动纳入策略可在 Dashboard 调整。',
  'cmd.project.chat_lookup_failed': '⚠️ 暂时无法确认群聊类型，未修改配置。请稍后重试。',
  'cmd.project.ordinary_group_required': '⚠️ /project 只能用于普通群聊；私聊、话题群和会话群不支持。',
  'cmd.project.bot_roster_unavailable': '⚠️ 暂时无法读取群内机器人名单，未修改配置。请确认机器人都已入群后重试。',
  'cmd.project.coordinator_not_in_chat': '⚠️ 群成员名单中找不到当前主控机器人，未修改配置。请确认机器人已加入本群后重试。',
  'cmd.project.coordinator_conflict': '⛔ 本群已由另一主控机器人管理（{value}），不能直接接管。请先由原主控执行 /project disable，或在 Dashboard 调整。',
  'cmd.project.project_mode_required': '⚠️ 当前群尚未启用项目群模式。请先发送：@机器人 /project enable',
  'cmd.project.unknown_subcommand': '未知子命令：{value}\n支持：/project enable | status | roles | disable | help',
  'cmd.project.unexpected_arguments': '/project 的这个子命令不接受额外参数：{value}\n支持：/project enable | status | roles | disable | help',
  'cmd.project.failed': '⚠️ 项目群配置失败：{reason}',
  'cmd.project.none': '无',
  'cmd.project.waiting': '待启动（可以先讨论）',
  'cmd.project.worker_policy_auto': '自动纳入新加入的本机 Bot（可在 Dashboard 关闭）',
  'cmd.project.worker_policy_manual': '仅使用显式 Worker 名单',
  'cmd.project.enabled': '✅ 已启用项目群模式\n主控：{coordinator}\nWorker：{workers}\nWorker 策略：{workerPolicy}\n\n协作配置已立即生效；待启动指引卡已发送并置顶。接下来直接在群消息顶层 @主控讨论或描述目标即可。',
  'cmd.project.reenabled': '✅ 已重新启用项目群模式\n主控：{coordinator}\nWorker：{workers}\nWorker 策略：{workerPolicy}\n\n已保留原有项目状态和进度卡，可继续推进。',
  'cmd.project.already_enabled': '✅ 本群已经是项目群\n主控：{coordinator}\nWorker：{workers}\nWorker 策略：{workerPolicy}\n\n现有 Worker 选择与自动纳入策略已保留，未被重复命令覆盖。',
  'cmd.project.card_deferred': '⚠️ 配置已生效，但待启动指引卡暂未更新；可稍后重新执行 /project enable。',
  'cmd.project.status_standard': '当前是普通协作模式。\n\n在群消息顶层发送：@机器人 /project enable',
  'cmd.project.status_project': '📌 当前是项目群模式\n主控：{coordinator}\nWorker：{workers}\nWorker 策略：{workerPolicy}\n项目：{runtime}',
  'cmd.project.disabled': '✅ 已退出项目群模式；如存在未启动的置顶指引卡，也已取消。',
  'cmd.project.already_disabled': '当前不是项目群，无需退出。',
  'cmd.project.project_retained': '已有项目状态和进度卡仍保留；重新启用同一主控后可继续。',
  ...
  'help.topic': '[标题] /t [/repo 仓库 | /repo wt 仓库 [分支]] [/model 模型] [/effort 档位] [首轮任务]  (别名 /topic) - 普通群内新开话题，一条消息交代完标题/仓库/模型/推理强度/首轮任务。换行等价于空格；标题写在 /t 之前（飞书话题列表显示的是原消息，bot 改不了）；带空格的路径用双引号；指令任一项写错则整条不生效并回一句用法错误。裸 /t 进入话题设置（需选仓则弹卡，否则等待下一条任务或 /repo）；头部里裸写 /repo（不带参数）= 直接在默认目录开会话，与选仓卡的「直接开始」一致。/repo wt 仓库 [分支] 在该仓库上新建 worktree 再开会话：分支可省略（按标题/正文自动命名），写了则只认与仓库同一行、长得像分支名的下一个词，所以英文开头的正文请换行再写。注意头部里的 /repo 只吃一个 token，会话中途单发的 /repo 仍吃整行',
  ...
  'help.sessions': '/sessions   - 列出当前机器人在本群的话题会话，并可返回或恢复话题',
  ...
  'help.project': '/project enable|status|disable - 在当前普通群启用、查看或退出项目群模式（owner 专用）',
  ...
  'xpi.choice.suggestion': '留给当前任务',
  'xpi.card.classify.prompt': '{at} 当前有其他成员的任务正在执行。请选一种处理方式：',
  'xpi.card.classify.independent': '另开任务',
  'xpi.card.classify.suggestion': '留给当前任务',
  'xpi.card.wait.prompt': '{at} 原任务还在执行。请选择：',
  'xpi.card.wait.continue': '继续等',
  'xpi.card.wait.independent': '另开任务',
  'xpi.notice.staged': '消息已暂存，不会打断当前任务。',
  ...
  'daemon.prompt_gate_denied': '🚫 本条消息被前置校验拦截，未提交给 CLI。',
  ...
  'daemon.force_topic_current_dir_missing': '⚠️ 当前群聊还没有可复用的工作目录。请先在普通群启动一个会话或使用 /oncall bind 绑定目录。',
  ...
  'daemon.cascade_busy': '⚠️ 上一条级联还在执行，这条请等它完成后再发。',
  'daemon.cascade_failed': '⚠️ 级联执行中断：前 {done} 条已送出，剩余 {remaining} 条没有送达；请只重发未送达的部分，不要整条重发。',
  'daemon.choose_repo_no_card': '请先在本话题内用 `/repo <路径|项目名>` 或 `/repo wt <仓库> [分支]` 选择仓库，您的消息已暂存，选好后会自动发送。',
  ...
  'daemon.topic_header_ready_model': '模型 {model}',
  'daemon.topic_header_ready_effort': '推理档位 {effort}',
  'daemon.topic_header_rejected': '⚠️ 话题指令头有问题，本条没有开话题：\n{reasons}\n\n{usage}',
  'daemon.topic_header_usage': '用法：`[标题] /t [/repo 仓库 | /repo wt 仓库 [分支]] [/model 模型] [/effort 档位] 首轮任务`（换行等价于空格；带空格的路径用双引号；`wt` 的可选分支只认与仓库同一行、长得像分支名的下一个词，英文开头的正文请换行再写）。',
  'daemon.topic_header_missing_arg': '`{directive}` 缺少参数',
  'daemon.topic_header_duplicate': '`{directive}` 重复出现，同一条指令只能写一次',
  ...
  'daemon.topic_header_worktree_missing_target': '`/repo wt` 缺少目标仓库：`/repo wt <路径|项目名> [分支]`',
  'daemon.topic_header_repo_not_git': '`{arg}` 不是 git 仓库，建不了 worktree',
  'daemon.topic_header_branch_invalid': '`{arg}` 不是合法的分支名（`git check-ref-format` 不通过）',
  'daemon.topic_header_worktree_exists': 'worktree 目标目录已存在：`{path}`（换个分支名，或在话题内用 `/repo {path}` 直接打开它）',
  ...
  'daemon.topic_header_effort_unsupported_cli': '当前 CLI（{cli}）没有推理档位开关',
  'daemon.topic_header_effort_unsupported_model': '模型 {model} 不支持推理档位 {effort}',
  ...
  'card.group_sessions.summary': '活跃 {active} · 已关闭 {closed} · 第 {page}/{totalPages} 页',
  'card.group_sessions.empty': '当前机器人在本群没有话题会话。',
  'card.group_sessions.untitled': '未命名话题',
  'card.group_sessions.status_unknown': '未知状态',
  'card.group_sessions.status_closed': '已关闭',
  'card.group_sessions.time.just_now': '刚刚',
  'card.group_sessions.time.seconds': '{n} 秒前',
  'card.group_sessions.time.minutes': '{n} 分钟前',
  'card.group_sessions.time.hours': '{n} 小时前',
  'card.group_sessions.time.days': '{n} 天前',
  'card.group_sessions.open_topic': '↗ 回到话题',
  'card.group_sessions.locate_topic': '📍 定位话题',
  'card.group_sessions.prev': '← 上一页',
  'card.group_sessions.next': '下一页 →',
  'card.group_sessions.refresh': '🔄 刷新',
  'card.group_sessions.resume': '▶ 恢复',
  'card.group_sessions.resume_confirm_title': '确认恢复会话？',
  'card.group_sessions.resume_confirm_text': '恢复后可在原话题中继续对话。会话：{title}',
  'card.group_sessions.footer': '数据截至 {time}，点击刷新获取最新状态。工作目录、完整 session ID 和终端链接已隐藏。',
  'card.group_sessions.unavailable': '⚠️ 当前会话无法查看话题会话列表。',
  'card.group_sessions.group_only': '`/sessions` 仅支持在群聊中使用。',
  'card.group_sessions.list_failed': '⚠️ 拉取话题会话失败：{reason}',
  'card.group_sessions.not_invoker': '只有打开这张卡片的人可以操作。',
  'card.group_sessions.invalid_action': '⚠️ 无效的卡片操作。',
  'card.group_sessions.binding_invalid': '⚠️ 这张卡片已不再绑定当前群。',
  'card.group_sessions.session_not_found': '⚠️ 该话题会话已迁移或不再可用。',
  'card.group_sessions.locate_success': '📬 已在原话题发送定位标记。',
  'card.group_sessions.locate_failed': '⚠️ 定位话题失败：{reason}',
  'card.group_sessions.resume_owner_only': '仅 Bot 管理员可以恢复会话。',
  'card.group_sessions.resume_unavailable': '⚠️ 该会话已恢复、已迁移或不再可恢复。',
  'card.group_sessions.resume_failed': '⚠️ 恢复会话失败：{reason}',
  'card.group_sessions.resume_success': '✅ 会话已恢复。',
  ...
  'card.dashboard.groups.project_roles.title': '🎭 项目群角色配置',
  'card.dashboard.groups.project_roles.help': '只配置各 Agent 在本群中的职责；目标、进度和任务不在这里填写。',
  'card.dashboard.groups.project_roles.coordinator': '主控',
  'card.dashboard.groups.project_roles.worker': 'Worker',
  'card.dashboard.groups.project_roles.inherited': '未设置群角色，将继承该 Bot 的团队默认角色（如有）',
  'card.dashboard.groups.project_roles.edit': '编辑群角色',
  'card.dashboard.groups.project_roles.empty': '当前项目配置中没有可编辑的 Agent。',
  'card.dashboard.groups.project_roles.footer': '与 /role 和 Dashboard 共用同一份群角色配置；每轮注入模式从下一条消息生效，仅首轮模式在新会话或重建后生效。',
