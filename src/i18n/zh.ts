...
export const messages: Record<string, string> = {
  ...
  'trigger_user_auth.denied_auto_login': 'botmux: 已自动发起 ByteCloud 登录，请直接打开下面的链接完成授权：',
  'trigger_user_auth.denied_auto_retry': 'botmux: 授权后直接重试原操作；Botmux 会自动完成登录，不需要再发送 /login bytedcli 或 done。',
